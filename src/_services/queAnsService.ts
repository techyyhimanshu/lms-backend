...
const queryQuestion = async (
    ...
    try {
        ...
        const result: any = await sequelize.query(`
            INSERT INTO LMS.tbl_queAns (question,tutorURN,studentId,answerDate,createdAt)
            VALUES (:question,
...
const getAllTutorQuery = async (
    ...
    try {
        const result: any = await sequelize.query(`SELECT qaId,question,answer,STUDENT.NAME ,tbl_queAns.studentId,createdAt,answerDate 
            from LMS.tbl_queAns JOIN LMS.STUDENT ON STUDENT.STUDENTID = tbl_queAns.studentId 
...
const getAllStuQuery = async (
    ...
    try {
        const result: any = await sequelize.query(`SELECT qaId,question,answer,STUDENT.NAME ,tbl_queAns.studentId,createdAt,answerDate, 
            tutorURN from LMS.tbl_queAns JOIN LMS.STUDENT ON STUDENT.STUDENTID = tbl_queAns.studentId 
...
const answerQuery = async (
    ...
    let res: any = [];
    try {
        const result: any = await sequelize.query(`UPDATE LMS.tbl_queAns set answer = :answer  
